...
- **OrientationSession**: private, repeatable Bussola conversation with validated tool recommendations and a reviewable Taccuino draft. It is separate from profiles and questionnaire results; completion of the first session unlocks the ordinary student routes.
