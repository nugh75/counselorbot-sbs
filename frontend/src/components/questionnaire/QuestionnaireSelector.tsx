    ...
    return (
        <div className="space-y-6">
            <div className="text-center mb-8">
                ...
                <h2 className="text-2xl font-bold text-slate-800">Scegli il Questionario</h2>
                <p className="text-slate-500 mt-2">Seleziona quale strumento di valutazione vuoi analizzare</p>
            </div>
