...
const TEXTS = {
    it: {
        ...
        profile: 'Taccuino dello studente (modello del discente)',
        ...
        messagePlaceholder: 'Scrivi un messaggio: lo studente lo vede nella sua area personale web e su Telegram se collegato.',
        send: 'Invia',
        sent: 'Inviato',
    ...
    en: {
        ...
        profile: 'Student notebook (learner model)',
        ...
        messagePlaceholder: 'Write a message: the student sees it in their personal area on the web and on Telegram if linked.',
        send: 'Send',
        sent: 'Sent',
