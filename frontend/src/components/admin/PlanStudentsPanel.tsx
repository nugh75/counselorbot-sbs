...
const TEXTS = {
    it: {
        ...
        empty: 'Nessun partecipante ha ancora risultati in questo piano.',
        telegram: 'Telegram collegato',
        profile: 'Taccuino del partecipante (modello del discente)',
        transcript: 'Conversazione',
        notes: 'Note',
        notePlaceholder: 'Nuova nota sul partecipante...',
        visible: 'Visibile al partecipante',
        addNote: 'Salva nota',
        message: 'Messaggio al partecipante',
        messagePlaceholder: 'Scrivi un messaggio: il partecipante lo vede nella sua area personale web e su Telegram se collegato.',
        send: 'Invia',
        sent: 'Inviato',
        ...
        loading: 'Carico...',
        deleteNote: 'Elimina',
        tests: 'test', studentRole: 'Partecipante',
    },
    en: {
        students: "Participants",
        empty: 'No participant has results in this plan yet.',
        telegram: 'Telegram linked',
        profile: 'Participant notebook (learner model)',
        transcript: 'Conversation',
        notes: 'Notes',
        notePlaceholder: 'New note about the participant...',
        visible: 'Visible to the participant',
        addNote: 'Save note',
        message: 'Message to the participant',
        messagePlaceholder: 'Write a message: the participant sees it in their personal area on the web and on Telegram if linked.',
        send: 'Send',
        sent: 'Sent',
        ...
        loading: 'Loading...',
        deleteNote: 'Delete',
        tests: 'tests', studentRole: 'Participant',
    },
    es: {
        students: "Participantes", empty: 'Ningún participante tiene aún resultados en este plan.', telegram: 'Telegram vinculado',
        profile: 'Cuaderno del participante (modelo del alumno)', transcript: 'Conversación', notes: 'Notas',
        notePlaceholder: 'Nueva nota sobre el participante...', visible: 'Visible para el participante', addNote: 'Guardar nota',
        message: 'Mensaje al participante', messagePlaceholder: 'Escribe un mensaje: el participante lo verá en su área personal web y en Telegram si está vinculado.',
        send: 'Enviar', sent: 'Enviado', sentTelegram: 'Enviado (también por Telegram)', error: 'La operación ha fallado.',
        loading: 'Cargando...', deleteNote: 'Eliminar', tests: 'pruebas', studentRole: 'Participante',
    },
    fr: {
        students: "Participants", empty: 'Aucun participant n’a encore de résultats dans ce plan.', telegram: 'Telegram associé',
        profile: 'Carnet du participant (modèle de l’apprenant)', transcript: 'Conversation', notes: 'Notes',
        notePlaceholder: 'Nouvelle note sur le participant...', visible: 'Visible par le participant', addNote: 'Enregistrer la note',
        message: 'Message au participant', messagePlaceholder: 'Écrivez un message : le participant le verra dans son espace personnel web et sur Telegram s’il est associé.',
        send: 'Envoyer', sent: 'Envoyé', sentTelegram: 'Envoyé (également sur Telegram)', error: 'L’opération a échoué.',
        loading: 'Chargement...', deleteNote: 'Supprimer', tests: 'tests', studentRole: 'Participant',
    },
    de: {
        students: "Teilnehmende", empty: 'Für diesen Plan liegen noch keine Ergebnisse von Teilnehmenden vor.', telegram: 'Telegram verknüpft',
        profile: 'Notizbuch der teilnehmenden Person (Lernendenmodell)', transcript: 'Unterhaltung', notes: 'Notizen',
        notePlaceholder: 'Neue Notiz zur teilnehmenden Person...', visible: 'Für die teilnehmende Person sichtbar', addNote: 'Notiz speichern',
        message: 'Nachricht an die teilnehmende Person', messagePlaceholder: 'Schreiben Sie eine Nachricht: Sie wird im persönlichen Webbereich und bei Verknüpfung auch auf Telegram angezeigt.',
        send: 'Senden', sent: 'Gesendet', sentTelegram: 'Gesendet (auch über Telegram)', error: 'Der Vorgang ist fehlgeschlagen.',
        loading: 'Wird geladen...', deleteNote: 'Löschen', tests: 'Tests', studentRole: 'Teilnehmende Person',
    },
    sv: {
        students: "Deltagare", empty: 'Ingen deltagare har ännu resultat i den här planen.', telegram: 'Telegram länkat',
        profile: 'Deltagarens anteckningsbok (lärandemodell)', transcript: 'Samtal', notes: 'Anteckningar',
        notePlaceholder: 'Ny anteckning om deltagaren...', visible: 'Synlig för deltagaren', addNote: 'Spara anteckning',
        message: 'Meddelande till deltagaren', messagePlaceholder: 'Skriv ett meddelande: deltagaren ser det i sin personliga webbvy och på Telegram om kontot är länkat.',
        send: 'Skicka', sent: 'Skickat', sentTelegram: 'Skickat (även via Telegram)', error: 'Åtgärden misslyckades.',
        loading: 'Laddar...', deleteNote: 'Ta bort', tests: 'test', studentRole: 'Deltagare',
    },
};
