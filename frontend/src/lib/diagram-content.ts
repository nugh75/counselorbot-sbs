...
export type DiagramIcon = 'book' | 'brain' | 'check' | 'clock' | 'compass' | 'heart' | 'idea' | 'question' | 'shield' | 'target' | 'calendar' | 'tasks' | 'dialogue' | 'choice' | 'focus' | 'repeat' | 'review' | 'delay' | 'search' | 'notes' | 'connections' | 'structure' | 'compare' | 'obstacle' | 'distraction' | 'uncertainty' | 'support' | 'cooperation' | 'feedback' | 'progress' | 'fatigue' | 'energy' | 'distress' | 'pause' | 'start' | 'finish' | 'evidence' | 'experiment' | 'resources' | 'listening' | 'route' | 'deadline' | 'context' | 'digital' | 'work' | 'study' | 'measure' | 'agreement' | 'writing' | 'observation' | 'priority' | 'sequence' | 'reminder' | 'habit' | 'workload' | 'pace' | 'waiting' | 'milestone' | 'direction' | 'destination' | 'constraint' | 'access' | 'risk' | 'conflict' | 'change' | 'error' | 'correction' | 'detail' | 'overview' | 'audio' | 'explanation' | 'synthesis' | 'creativity' | 'calculation' | 'data' | 'document' | 'folder' | 'link' | 'hierarchy' | 'puzzle' | 'language' | 'online' | 'privacy' | 'safety' | 'wellbeing' | 'anger' | 'breathing' | 'sleep' | 'movement' | 'growth' | 'exercise' | 'health' | 'family' | 'community' | 'teaching' | 'qualification' | 'portfolio' | 'interview' | 'experience' | 'individual';
...
export const DIAGRAM_ICONS: DiagramIcon[] = ['book', 'brain', 'check', 'clock', 'compass', 'heart', 'idea', 'question', 'shield', 'target', 'calendar', 'tasks', 'dialogue', 'choice', 'focus', 'repeat', 'review', 'delay', 'search', 'notes', 'connections', 'structure', 'compare', 'obstacle', 'distraction', 'uncertainty', 'support', 'cooperation', 'feedback', 'progress', 'fatigue', 'energy', 'distress', 'pause', 'start', 'finish', 'evidence', 'experiment', 'resources', 'listening', 'route', 'deadline', 'context', 'digital', 'work', 'study', 'measure', 'agreement', 'writing', 'observation', 'priority', 'sequence', 'reminder', 'habit', 'workload', 'pace', 'waiting', 'milestone', 'direction', 'destination', 'constraint', 'access', 'risk', 'conflict', 'change', 'error', 'correction', 'detail', 'overview', 'audio', 'explanation', 'synthesis', 'creativity', 'calculation', 'data', 'document', 'folder', 'link', 'hierarchy', 'puzzle', 'language', 'online', 'privacy', 'safety', 'wellbeing', 'anger', 'breathing', 'sleep', 'movement', 'growth', 'exercise', 'health', 'family', 'community', 'teaching', 'qualification', 'portfolio', 'interview', 'experience', 'individual'];
