...
const it = {
    ...
    current: 'L’assegnazione raggiunge gli iscritti presenti al momento.', recipients: 'Destinatari',
    send: 'Conferma assegnazione', cancel: 'Annulla', saved: 'Assegnazione inviata.',
    emptyTargets: 'Nessun gruppo o classe con partecipanti disponibile.',
