...
const it: Dict = {
    ...
    'orientation.feature.reflect.body': 'Il Taccuino si apre all’inizio e alla fine: lo scrivi tu, la Bussola non lo modifica.',
...
const en: Dict = {
    ...
    'orientation.feature.reflect.title': 'It makes the reasoning explicit', 'orientation.feature.reflect.body': 'Your notebook opens at the start and at the end: you write it, the Compass never edits it.',
...
const es: Dict = {
    ...
    'orientation.feature.reflect.title': 'Explicita el razonamiento', 'orientation.feature.reflect.body': 'El cuaderno se abre al principio y al final: lo escribes tú, la Brújula no lo modifica.',
...
const fr: Dict = {
    ...
    'orientation.feature.reflect.title': 'Elle explicite le raisonnement', 'orientation.feature.reflect.body': 'Le carnet s’ouvre au début et à la fin : c’est vous qui l’écrivez, la Boussole ne le modifie pas.',
...
const de: Dict = {
    ...
    'orientation.feature.reflect.title': 'Er macht die Begründung sichtbar', 'orientation.feature.reflect.body': 'Das Notizbuch öffnet sich am Anfang und am Ende: Du schreibst es, der Kompass ändert es nicht.',
...
const sv: Dict = {
    ...
    'orientation.feature.reflect.title': 'Den synliggör resonemanget', 'orientation.feature.reflect.body': 'Anteckningsboken öppnas i början och i slutet: du skriver den, Kompassen ändrar den inte.',
