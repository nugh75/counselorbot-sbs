...
STEP_LABEL_I18N: Dict[str, Dict[str, str]] = {
    ...
    "qpcs-emozioni": {
        "en": "2. Managing Emotions", "es": "2. Gestión de las Emociones",
        "fr": "2. Gestion des Émotions", "de": "2. Umgang mit Emotionen",
        "sv": "2. Känslohantering",
    },
    "qpcs-comunicazione": {
        "en": "3. Communication Competence", "es": "3. Competencia Comunicativa",
        "fr": "3. Compétence Communicative", "de": "3. Kommunikative Kompetenz",
        "sv": "3. Kommunikativ kompetens",
    },
    "qpcs-volizione": {
        "en": "4. Will and Perseverance", "es": "4. Voluntad y Perseverancia",
        "fr": "4. Volonté et Persévérance", "de": "4. Wille und Ausdauer",
        "sv": "4. Vilja och uthållighet",
    },
    "qpcs-apprendimento": {
        "en": "5. Strategies and Collaboration", "es": "5. Estrategias y Colaboración",
        "fr": "5. Stratégies et Collaboration", "de": "5. Strategien und Zusammenarbeit",
        "sv": "5. Strategier och samarbete",
    },
    "qpcs-fiducia": {
        "en": "6. Confidence and Life Project", "es": "6. Confianza y Proyecto de Vida",
        "fr": "6. Confiance et Projet de Vie", "de": "6. Zuversicht und Lebensplan",
        "sv": "6. Tillit och livsprojekt",
    },
    "qpcs-sintesi": {
        "en": "7. Synthesis and Action Plan", "es": "7. Síntesis y Plan de Acción",
        "fr": "7. Synthèse et Plan d'Action", "de": "7. Synthese und Aktionsplan",
        "sv": "7. Syntes och handlingsplan",
    },
    ...
    "qpcc-comunicazione": {
        "en": "2. Public Speaking", "es": "2. Comunicación en Público",
        "fr": "2. Communication en Public", "de": "2. Sprechen vor Publikum",
        "sv": "2. Att tala inför publik",
    },
    "qpcc-controllo": {
        "en": "3. Anxiety, Control and Responsibility", "es": "3. Ansiedad, Control y Responsabilidad",
        "fr": "3. Anxiété, Contrôle et Responsabilité", "de": "3. Angst, Kontrolle und Verantwortung",
        "sv": "3. Oro, kontroll och ansvar",
    },
    "qpcc-volizione": {
        "en": "4. Volition and Self-regulation", "es": "4. Volición y Autorregulación",
        "fr": "4. Volition et Autorégulation", "de": "4. Volition und Selbstregulation",
        "sv": "4. Volition och självreglering",
    },
    "qpcc-elaborazione": {
        "en": "5. Elaboration Strategies", "es": "5. Estrategias de Elaboración",
        "fr": "5. Stratégies d'Élaboration", "de": "5. Verarbeitungsstrategien",
        "sv": "5. Bearbetningsstrategier",
    },
    "qpcc-convinzioni": {
        "en": "6. Beliefs about Oneself", "es": "6. Convicciones sobre Sí Mismo",
        "fr": "6. Convictions sur Soi", "de": "6. Überzeugungen über sich selbst",
        "sv": "6. Föreställningar om sig själv",
    },
    "qpcc-sintesi": {
        "en": "7. Synthesis and Action Plan", "es": "7. Síntesis y Plan de Acción",
        "fr": "7. Synthèse et Plan d'Action", "de": "7. Synthese und Aktionsplan",
    ...
    "qap-preoccupazione": {
        "en": "2. Future Orientation", "es": "2. Orientación al Futuro",
        "fr": "2. Orientation vers l'Avenir", "de": "2. Zukunftsorientierung",
        "sv": "2. Framtidsorientering",
    },
    "qap-controllo": {
        "en": "3. Control and Autonomy", "es": "3. Control y Autonomía",
        "fr": "3. Contrôle et Autonomie", "de": "3. Kontrolle und Autonomie",
        "sv": "3. Kontroll och autonomi",
    },
    "qap-curiosita": {
        "en": "4. Curiosity and Exploration", "es": "4. Curiosidad y Exploración",
        "fr": "4. Curiosité et Exploration", "de": "4. Neugier und Erkundung",
        "sv": "4. Nyfikenhet och utforskande",
    },
    "qap-fiducia": {
        "en": "5. Confidence and Problem Solving", "es": "5. Confianza y Resolución de Problemas",
        "fr": "5. Confiance et Résolution de Problèmes", "de": "5. Zuversicht und Problemlösen",
        "sv": "5. Tillit och problemlösning",
    },
    "qap-sintesi": {
    ...
    # --- Idea ---
    "idea-intro": {
        "en": "What we are talking about", "es": "De qué hablamos",
        "fr": "De quoi parlons-nous", "de": "Worum es geht",
        "sv": "Vad vi talar om",
    },
    "idea-statement": {
        "en": "The idea in one sentence", "es": "La idea en una frase",
        "fr": "L'idée en une phrase", "de": "Die Idee in einem Satz",
        "sv": "Idén i en mening",
    },
    "idea-assumptions": {
        "en": "What I take for granted", "es": "Qué doy por sentado",
        "fr": "Ce que je tiens pour acquis", "de": "Was ich voraussetze",
        "sv": "Vad jag tar för givet",
    },
    "idea-evidence": {
        "en": "What I am basing this on", "es": "En qué me baso",
        "fr": "Sur quoi je m'appuie", "de": "Worauf ich mich stütze",
        "sv": "Vad jag bygger på",
    },
    "idea-alternatives": {
        "en": "How else it could be seen", "es": "Cómo podría verse de otro modo",
        "fr": "Comment le voir autrement", "de": "Wie man es anders sehen könnte",
        "sv": "Hur det kan ses annorlunda",
    },
    "idea-implications": {
        "en": "Where it leads", "es": "Adónde lleva",
        "fr": "Où cela mène", "de": "Wohin es führt",
        "sv": "Vart det leder",
    },
    "idea-question": {
        "en": "Is it the right question?", "es": "¿Es la pregunta correcta?",
        "fr": "Est-ce la bonne question ?", "de": "Ist es die richtige Frage?",
        "sv": "Är det rätt fråga?",
    },
    "idea-synthesis": {
        "en": "Map and next step", "es": "Mapa y próximo paso",
        "fr": "Carte et prochaine étape", "de": "Karte und nächster Schritt",
        "sv": "Karta och nästa steg",
    },
}
