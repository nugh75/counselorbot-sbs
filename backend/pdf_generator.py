...
FACTOR_TRANS: dict[str, dict[str, tuple[str, str]]] = {
    "it": {
        ...
        "C5": ("Organizzatori semantici", "Uso di mappe e schemi"),
    ...
    "en": {
        ...
        "C5": ("Semantic organisers", "Use of maps and diagrams"),
    ...
    "es": {
        ...
        "C5": ("Organizadores semánticos", "Uso de mapas y esquemas"),
    ...
    "fr": {
        ...
        "C5": ("Organisateurs sémantiques", "Usage de cartes et de schémas"),
    ...
    "de": {
        ...
        "C5": ("Semantische Organisatoren", "Verwendung von Karten und Diagrammen"),
    ...
    "sv": {
        ...
        "C5": ("Semantiska organisatörer", "Användning av kartor och scheman"),
