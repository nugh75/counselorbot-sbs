# Graph Report - /home/nugh75/counselorbot-sbs/docs  (2026-08-30)
...
- `Catalogo item - scaffolding multilingue (IT/EN/SV)` --semantically_similar_to--> `Manuale Operativo per la Validazione del QSAr (EN in Svezia)`  [INFERRED] [semantically similar]
  questionari/item-catalog.md → validazione/manuale-operativo-validazione.md
